...
for model in models:
    ...
    f = open("/data/a.saricaoglu/Plots/" + str(c.strftime("%m.%d")) + "/" + model + "_outputs.txt", "a")
    ...
    for f in arrays_to_save:
        name = filenames[i]
        np.savetxt("/data/a.saricaoglu/Files/" + model + "/" + name + "_" + str(c.strftime("%m.%d")) + ".txt", f)
        i+=1
