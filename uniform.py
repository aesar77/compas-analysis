...
matplotlib.rcParams['legend.loc'] = 1
...
pathToData = '/data/a.saricaoglu/Runs/Uniform/'
...
plt.subplot(3,3,1)
plt.suptitle("Uniform IMF, Population size: " + str(len((mP_ins))) + ", CE positive: " + str(len(mP_ins_masked)))
...
plt.savefig("/data/a.saricaoglu/Plots/Uniform_hist.png")
plt.show()
...
plt.subplots_adjust(top=0.93, bottom=0.07, left=0.1, right=0.9, hspace=0.32, wspace=0.235)
plt.savefig("/data/a.saricaoglu/Plots/Uniform_scatter.png")
plt.show()
...
# plt.savefig("/data/a.saricaoglu/Plots/Uniform_T.png")
# plt.show()
