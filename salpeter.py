...
pathToData = '/data/a.saricaoglu/Runs/Salpeter/'
...
plt.subplot(3,3,1)
plt.suptitle("Salpeter+Kroupa IMF, Population size: " + str(len((mP_ins))) + ", CE positive: " + str(len(mP_ins_masked)))
...
plt.subplot(3,3,2)
plt.suptitle("Salpeter+Kroupa IMF")
...
plt.savefig("/data/a.saricaoglu/Plots/SalpeterKroupa_hist.png")
plt.show()
...
plt.subplots_adjust(top=0.93, bottom=0.07, left=0.1, right=0.9, hspace=0.32, wspace=0.235)
plt.savefig("/data/a.saricaoglu/Plots/SalpeterKroupa_scatter.png")
plt.show()
...
# plt.savefig("/data/a.saricaoglu/Plots/Salpeter_T.png")
# plt.show()
