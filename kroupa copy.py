...
for model in models:
    ...
    hist1 = plt.hexbin(semax_innms, mP_innms, gridsize=30, alpha=1, cmap='Reds', xscale="log", yscale="log", bins="log")
    ...
    hist1 = plt.hexbin(semax_innms, mS_innms, gridsize=30, alpha=1, cmap='Reds', xscale="log", yscale="log", bins="log")
    ...
    hist1 = plt.hexbin(semax_innms, np.add(mS_innms, mP_innms), gridsize=30, alpha=1, cmap='Reds', xscale="log", yscale="log", bins="log")
    ...
    hist1 = plt.hexbin(semax_preCEs, mP_preCEs, gridsize=30, alpha=1, cmap='Blues', xscale="log", yscale="log", bins="log")
    plt.colorbar(hist1, orientation='vertical')
    plt.xlabel("Semimajor Axis [AU]")
    ...
    hist1 = plt.hexbin(semax_preCEs, mS_preCEs, gridsize=30, alpha=1, cmap='Blues', xscale="log", yscale="log", bins="log")
    plt.colorbar(hist1, orientation='vertical')
    plt.xlabel("Semimajor Axis [AU]")
    plt.ylabel("$M_s$ before CE [$M_{\odot}$]")
    plt.yscale("log")
    ...
    hist1 = plt.hexbin(semax_preCEs, np.add(mS_preCEs,mS_preCEs), gridsize=30, alpha=1, cmap='Blues', xscale="log", yscale="log", bins="log")
    plt.colorbar(hist1, orientation='vertical')
    plt.xlabel("Semimajor Axis [AU]")
    ...
    hist1 = plt.hexbin(semax_pstCEs, mP_pstCEs, gridsize=30, alpha=1, cmap='Blues', xscale="log", yscale="log", bins="log")
    plt.colorbar(hist1, orientation='vertical')
    plt.xlabel("Semimajor Axis [AU]")
    ...
    hist1 = plt.hexbin(semax_pstCEs, mS_pstCEs, gridsize=30, alpha=1, cmap='Blues', bins="log")
    plt.colorbar(hist1, orientation='vertical')
    plt.xlabel("Semimajor Axis [AU]")
    plt.ylabel("$M_s$ after CE [$M_{\odot}$]")
    plt.yscale("log")
    ...
    hist1 = plt.hexbin(semax_pstCEs, np.add(mS_pstCEs, mP_pstCEs), gridsize=30, alpha=1, cmap='Blues', xscale="log", yscale="log", bins="log")
    plt.colorbar(hist1, orientation='vertical')
    plt.xlabel("Semimajor Axis [AU]")
    ...
    hist1 = plt.hexbin(ma.masked_array(mP_innms, mask=maskSPBoundBinary),ma.masked_array(mS_innms, mask=maskSPBoundBinary), gridsize=30, alpha=1, cmap='Reds', xscale="log", yscale="log", bins="log")
